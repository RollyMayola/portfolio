        ...
        <TabPanel>
          <ul className="row grid justify-content-center">
            ...
            >
              <figure onClick={toggleModalOne}>
                ...
                <div className=" hover-content-wrapper">
                  <span className="content-title">Logiciel de gestion de projet</span>
                </div>
              </figure>
            ...
            >
              ...
              >
                <img src="img/projects/siteSecurite.png" alt="Portolio" />
                <div className=" hover-content-wrapper">
                  <span className="content-title"> Site web Vitrine</span>
                </div>
              </figure>
            ...
            >
              ...
              >
                <img src="img/projects/sitedesport.png" alt="Portolio" />
                <div className=" hover-content-wrapper">
                  <span className="content-title"> Logiciel de vente de produit</span>
                </div>
              </figure>
          ...
          <ul className="row grid justify-content-center">
            ...
            >
              ...
              >
                <img src="img/projects/siteSecurite.png" alt="Portolio" />
                <div className=" hover-content-wrapper">
                  <span className="content-title"> Site web</span>
                </div>
              </figure>
          ...
          <ul className="row grid justify-content-center">
            ...
            >
              ...
              >
                <img src="img/projects/sitedesport.png" alt="Portolio" />
                <div className=" hover-content-wrapper">
                  <span className="content-title"> Logiciel de vente d'articles</span>
                </div>
              </figure>
